...
export const createOrganizationSchema = z.object({
  name: z.string().min(3, 'Organization name must be more than 3 characters long'),
  slug: z.string().min(3, 'Organization slug must be more than 3 characters long'),
});
...
export const inviteUserSchema = z.object({
  ...
  (data) => data.invitedUserId || data.invitedUserEmail,
